...
[latest]: https://github.com/ionutbortis/gnome-bedtime-mode/releases/download/v7.0/gnome-bedtime-mode_7.0.zip
...
```
wget https://github.com/ionutbortis/gnome-bedtime-mode/releases/download/v7.0/gnome-bedtime-mode_7.0.zip
# (Or manually download via browser and run the next commands from the download folder)

gnome-extensions install --force gnome-bedtime-mode_7.0.zip

rm gnome-bedtime-mode_7.0.zip
```
